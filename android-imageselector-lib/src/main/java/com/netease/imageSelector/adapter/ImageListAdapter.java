...
import static com.netease.imageSelector.ImageSelectorConstant.MODE_SINGLE;
...
//                    .load(new File(image.getPath()))
                    ...
                    .centerCrop()
                    .thumbnail(0.5f)
                    .placeholder(ImageSelectorProxy.getInstance().getImageOnLoading(context.getResources()))
                    .error(ImageSelectorProxy.getInstance().getImageOnError(context.getResources()))
                    .dontAnimate()
